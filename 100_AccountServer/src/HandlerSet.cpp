...
IHandler* CHandlerSet::GetHandler(const unsigned int uiMsgID, EAccountMsgType enMsgType)
{
    if(uiMsgID >= MAX_ACCOUNT_HANDLER_NUMBER)
    {
...
int CHandlerSet::RegisterHandler(const unsigned int uiMsgID, IHandler* pHandler, EAccountMsgType enMsgType)
{
